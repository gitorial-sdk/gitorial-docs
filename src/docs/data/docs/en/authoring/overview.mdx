...
description: "How to author Gitorials effectively: edit steps confidently and open great PRs."
tab: "main"
sidebar:
  label: "Overview"
  order: 1
...
![Split view — left: Folded commit diff; right: corresponding Unfolded `step-03` folder](./assets/folded-unfolded-split-view.svg)
...
5. **Create PR-ready structure**<br/>
   ...
   This process expands the **Folded** state into an **Unfolded** representation, where each step is written to a corresponding `step-N/` folder.
